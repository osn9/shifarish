...
namespace SIFARIS.Areas.JanmaDarta.Models
{
    public class JanmaDartaModel
    {
        public JanmaDartaModel()
        {

            JanmaDartaModelList = new List<JanmaDartaModel>();
        ...
        public List<JanmaDartaModel> JanmaDartaModelList { get; set; }
        //panjika
