...
function showCalendarBox(t) {
...
} function hideCalendarBox() { $("#ndp-nepali-box").fadeOut(100) } function get2DigitNo(t) { return t = parseInt(t, 10), 10 > t ? "0" + ("" + t) : "" + t } function getMonths() {
    ...
    return e
} function makeArray() { for (i = 0; makeArray.arguments.length > i; i++) this[i + 1] = makeArray.arguments[i] } function englishNo2Nep(t) {
    t = "" + t
    ...
    return a + "-" + n + "-" + r
} function bs2ad(t) { return days_count = this.count_bs_days(this.bs_date_eq, t), this.add_ad_days(this.ad_date_eq, days_count) } function ad2bs(t) { return days_count = this.count_ad_days(this.ad_date_eq, t), this.add_bs_days(this.bs_date_eq, days_count) } (function (t) {
