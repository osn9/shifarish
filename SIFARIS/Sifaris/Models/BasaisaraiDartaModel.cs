...
{
    public class BasaisaraiDartaModel
    {
        public BasaisaraiDartaModel()
        {
            BasaisaraiDartaModelList =new List<BasaisaraiDartaModel>();
            BasaisaraiPersonalDetailsModelList = new List<BasaisaraiPersonalDetailsModel>();
        }
        ...
        public List<BasaisaraiDartaModel> BasaisaraiDartaModelList { get; set; }
        public List<BasaisaraiPersonalDetailsModel> BasaisaraiPersonalDetailsModelList { get; set; }
        //panjika
    ...
    public class BasaisaraiPersonalDetailsModel
    {
