...
namespace Sifaris.Providers
{
    public class JanmaDartaProvider
    {
        ...
        public void Insert(JanmaDartaModel model)
        {
            ...
            JanmaMiti = model.JanmaMiti,JanmaDate =Utility.GetRomanDate(model.JanmaMiti).ToString(),
            JanmaSthaan = model.JanmaSthaan,
            JanmadaMadatt=model.JanmadaMadatt,
            Gender=model.Gender,
            JanmaJaatJati=model.JanmaJaatJati,JanmaKisim=model.JanmaKisim,
            JanmaPradesh=model.JanmaPradesh,JanmaJilla=model.JanmaJilla,
            JanmaPalika=model.JanmaPalika,JanmaWardNo=model.JanmaWardNo,
            JanmaBidesh=model.JanmaBidesh,JanmaForeign=model.JanmaForeign,
            BajekoNaam=model.BajekoNaam,GrandFather=model.GrandFather
