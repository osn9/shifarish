...
{
    public class MrityuDartaViewModel
    {
        public MrityuDartaViewModel()
        {
            MrityuDartaViewModelList = new List<MrityuDartaViewModel>();
        }
        ...
        public List<MrityuDartaViewModel> MrityuDartaViewModelList { get; set; }
