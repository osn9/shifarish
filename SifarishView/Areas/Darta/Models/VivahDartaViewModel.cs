...
{
    public class VivahDartaViewModel
    {
        public VivahDartaViewModel()
        {
            VivahDartaViewModelList = new List<VivahDartaViewModel>();
        ...
        public List<VivahDartaViewModel> VivahDartaViewModelList { get; set; }
