...
{
    public class DivorceDartaViewModel
    {
        public DivorceDartaViewModel()
        {
            DivorceDartaViewModelList = new List<DivorceDartaViewModel>();
        }
        public int DivorceId { get; set; }
        public int PanjiId { get; set; }
        [DisplayName("निर्णय गर्ने अदालतको किसिम")]
        public Nullable<int> CourtType { get; set; }
        [DisplayName("निर्णय गर्ने अदालतको जिल्ला")]
        public Nullable<int> District { get; set; }
        [DisplayName("अदालतको निर्णय नं.")]
        public string NirnayaNo { get; set; }
        [DisplayName("अदालतको निर्णय मिति")]
        public string NinayaMiti { get; set; }
        [DisplayName("विवाह दर्ता नं.")]
        public string VivahDartaNo { get; set; }
        public List<DivorceDartaViewModel> DivorceDartaViewModelList { get; set; }
        //panjika
        ...
        [DisplayName("सम्बन्ध बिच्छेद फारम दर्ता नं")]
